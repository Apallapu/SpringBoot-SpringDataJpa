 ...
 * 
 * 
 * File name:DepartmentConfig.java
 * 
 * File created Date:13 Sep, 2018
 * 
 ***********************************************************/
package com.ankamma.application.config;
...
public class DepartmentConfig {
    ...
    public Docket deptApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .build()
                .apiInfo(new ApiInfo("Micro service team", "dev", "1.0", "", new Contact("ankamma", "", "ankamma.java@gmail.com"), "", ""));
    }
